      ...
      <div class="hero-right">
        ...
        <div class="open-to-panel" aria-label="Currently open to">
          ...
          <ul class="open-to-list">
            <li>Senior Program/Project Manager (public health or nonprofit consulting)</li>
            <li>Grants/Program Coordinator (research or health nonprofit)</li>
            <li>Facilitation/Training Program Lead (workshop design and delivery)</li>
            <li>Community Health &amp; Access Program Manager</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    entries = [
        {
            ...
            "bullets": [
                "Coordinated six concurrent projects and workstreams, aligning timelines, deliverables, and stakeholder communication with organizational and client priorities.",
                "Led weekly team meetings and individual check-ins for project teams of four to nine members, preparing agendas, directing action-item follow-up, reviewing milestones, and assigning responsibilities.",
                "Conducted client intake meetings, developed and monitored scopes of work, and supported contracts, partnership agreements, and joint-venture agreements through issue identification and follow-up.",
                "Managed production of deliverables including toolkits, concept papers, a statewide strategic plan, workshop series, and facilitation guides for grant agencies, public health professionals, older adults living with disabilities or dementia and their caregivers, and government officials.",
                "Designed and facilitated more than 50 workshops, including virtual sessions addressing racism, oppression, health disparities, and related public health issues.",
                "Submitted quarterly progress summaries and final reports to funding agencies, collaborative partners, and clients, and co-monitored budgets with the Senior Financial Analyst.",
                "Supervised and mentored two staff members and reviewed work produced by research scientists and research and evaluation associates.",
                "Co-wrote five concept papers with collaborative partners for grant opportunities.",
            ],
        ...
        },
        {
            ...
            "bullets": [
                "Designed and taught six undergraduate and graduate courses related to race, health disparities, and applied medical anthropology.",
                "Developed curricula, learning management system materials, and interactive learning activities aligned with course objectives using instructional design principles.",
                "Supervised six undergraduate and graduate student practicum placements and mentored students in research and community engagement.",
                "Supported curriculum review, program assessment, and administrative planning through committee service.",
                "Published peer-reviewed work on grandparent caregiving and the social and cultural impact of caregiving on aging, and presented at national and international conferences.",
                "Secured funding for a research project on caregiving and social isolation in Memphis, Tennessee, and Detroit, Michigan.",
            ],
        ...
        },
        {
            ...
            "bullets": [
                "Developed instructional materials for two undergraduate courses using adult learning principles.",
                "Delivered interactive lectures integrating evidence-based public health concepts, including research design, evaluation, and data interpretation.",
                "Oversaw thesis development for three undergraduate students, mentoring them through end-to-end project development.",
            ],
        ...
        },
        {
            ...
            "bullets": [
                "Supported National Institutes of Health (NIH) R01 proposal development through drafting, editing, compliance reviews, and budget preparation, coordinating input across faculty and administrative stakeholders for a timely, compliant submission.",
                "Designed and implemented a professional development curriculum for students from underrepresented backgrounds, expanding access to research training and institutional support.",
                "Collaborated with a Community Research Liaison and Project Manager to strengthen the Center for Community Health Research&rsquo;s Community Steering Board.",
                "Conducted targeted literature reviews and presented dissertation findings at the American Anthropological Association annual meeting.",
            ],
        ...
        },
        {
            ...
            "bullets": [
                "Coordinated activities for a federally funded research project and supported biweekly budget reviews with the Principal Investigator.",
                "Prepared monthly expense reports and monitored project expenditures.",
                "Conducted qualitative and quantitative data transcription and analysis using MAXQDA and SAS, and maintained reference records in EndNote.",
                "Supervised and collaborated with undergraduate research assistants on research design, analysis, and presentation development.",
